package com.catface996.common.model;
 ...
 * Copyright 2021 猫脸 996. All rights reserved.
 */
@Data
...
public class OffsetPageModel<O, T> {
    ...
    public OffsetPageModel(List<T> records, O minOffset, O maxOffset, Integer size, boolean hasNext) {
