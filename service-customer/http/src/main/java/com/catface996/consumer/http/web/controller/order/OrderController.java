...
import com.catface996.consumer.http.web.controller.order.vo.SubmitOrderVO;
...
public class OrderController {
    ...
    public JsonResult<SubmitOrderVO> submitOrder(@RequestBody @Valid SubmitOrderRequest request) {
